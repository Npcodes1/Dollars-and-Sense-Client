    ...
    <div>
      <section class="section-container margin-space">
        <div class="content-wrapper">
          <h1 class="h1-title">WHAT IS A CREDIT SCORE?</h1>
          <p class="content-paragraph">
            A credit score is a three-digit number that is given to understand
            how good a person's credit is. Typically, these numbers run from 300
            to 850 and lenders, such as banks or financial companies, use this
            to understand how risky it is to lend someone money or issue them
            credit.
          </p>
          <p class="content-paragraph">
            Credit scores are important because the lower the credit score, the
            riskier the person is considered as a borrower, and the more
            unlikely they'll be given financial assistance. This could result in
            being disqualified from getting a new loan or mortgage, and could
            only leave high-interest rate options.
          </p>
          <h2 class="h2-title">
          ...
          <p class="content-paragraph">
            ...
            <ul class="content-list">
              <li>Payment history and how often on-time payments are made.</li>
              <li>
                Any outstanding balances owed and the percentage of total credit
                limit it accrues to.
              </li>
              <li>
          ...
          <h2 class="h2-title">HOW TO IMPROVE CREDIT SCORES?</h2>
          <p class="content-paragraph">
            ...
            <ul>
              ...
              <ul>
                <li>
                  ...
                  your report for seven years if it goes to a collection agency.
                  Consider automatic bill pay if you struggle with remembering
                  bill deadlines.
                </li>
              </ul>
          ...
          <h2 class="h2-title">HOW CAN I CHECK MY CREDIT SCORE?</h2>
          <p class="content-paragraph">
